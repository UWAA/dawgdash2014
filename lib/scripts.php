...
function roots_scripts() {
  wp_enqueue_style('roots_main', get_template_directory_uri() . '/assets/css/main.min.css', false, '0e6147846a75bd6fe33bac8d8e85eaa4');
...
// Flowtype, Modernizr Register
  ...
  wp_register_script('roots_scripts', get_template_directory_uri() . '/assets/js/scripts.min.js', array(), '74d9909130b57e7e771464cd41142316', true);
