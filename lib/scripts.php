...
function roots_scripts() {
  wp_enqueue_style('roots_main', get_template_directory_uri() . '/assets/css/main.min.css', false, 'ff1a29cb148db8d181afb01c8374bfd2');
...
// Flowtype, Modernizr Register
  ...
  wp_register_script('roots_scripts', get_template_directory_uri() . '/assets/js/scripts.min.js', array(), 'fd49d56dc548a38175b776d3d0c8d559', true);
