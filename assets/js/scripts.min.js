...
$(document).ready(function() {
    ...
    function getScrollDistance() {
        var pictureWidth = 149, holderWidth = $holder.width(), numberOfPictures = 12, visiblePictures = Math.round(holderWidth / pictureWidth), unseenPictures = numberOfPictures - visiblePictures;
